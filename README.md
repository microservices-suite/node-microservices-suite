...
- **Docker:** For containerization and managing containerized applications [install docker](https://docs.docker.com/engine/install/).
- **Task Runner Automation Tool:** For task automation and workflow management [install task runner](https://taskfile.dev/installation/).
