...
Welcome to node-microservices-suite! We value your feedback and contributions to make this project better. If you encounter any bugs or have feature requests, please use [Github issues](https://github.com/microservices-suite/node-microservices-suite/issues) issues to submit them.
...
- `feat`: Adding a new feature or significant functionality to the codebase.

- `fix`: Addressing bugs or issues in the existing codebase.
